...
<form style="padding-top:100px;justify-content:center;" action="./searchaController" method="post">
<label for="id"><b><strong style="color:#6351ce" class="p-2">Enter Author Name  : </strong></b></label><input type="text" id="name" name="name" style="height:35px;" required>
