...
<div
	...
	<form style="padding-top: 100px; text-align: left; margin-left: 100px;"
		action="./deleteController" method="post">
		<h4 style="color: white;">DELETE A BOOK</h4><br>
	...
	<%
	if(session.getAttribute("deletetest")==null){}
	else{
	%>
		<h5 class="p-4" style="background-color: black; color: white; width: 100%; text-align: center;margin-bottom:0px;padding-bottom:0px;"><%= session.getAttribute("deletetest") %></h5>
	<% 
	}
	session.invalidate();
	%>
