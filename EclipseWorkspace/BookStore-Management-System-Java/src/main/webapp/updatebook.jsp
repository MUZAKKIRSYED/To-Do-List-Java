...
<div
	...
	<form style="padding-top: 100px; text-align: left; margin-left: 100px;"
		action="./updateController" method="post">
		<h4 style="color: white;">UPDATE BOOK INFORMATION</h4><br>
	...
	<%
	if(session.getAttribute("updatetest")==null){}
	else{
	%>
		<h5 class="p-4" style="background-color: black; color: white; width: 100%; text-align: center;margin-bottom:0px;padding-bottom:0px;"><%= session.getAttribute("updatetest") %></h5>
	<% 
	}
	session.invalidate();
	%>
